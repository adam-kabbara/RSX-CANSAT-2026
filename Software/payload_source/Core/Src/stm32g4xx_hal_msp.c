...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  if(htim->Instance==TIM2)
  {
    ...
    PA1     ------> TIM2_CH2
    */
    GPIO_InitStruct.Pin = SERVO_WING_PWM_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM2;
    HAL_GPIO_Init(SERVO_WING_PWM_GPIO_Port, &GPIO_InitStruct);
  ...
  else if(htim->Instance==TIM3)
  {
    ...
    PB5     ------> TIM3_CH2
    */
    GPIO_InitStruct.Pin = SERVO_EGG_REL_Pin|SERVO_ELEVATOR_Pin|SERVO_AILERON_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  else if(htim->Instance==TIM4)
  {
    ...
    PA12     ------> TIM4_CH2
    */
    GPIO_InitStruct.Pin = SERVO_CC_REL_Pin|SERVO_NC_REL_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
