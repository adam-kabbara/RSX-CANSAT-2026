...
#define READINGCOUNT 250 //Maximum number of readings per sensor
...
extern CalibrationState cal_state; //global variable to track current face/state
extern SensorCalibration calibrator; //global instance of the calibration class
